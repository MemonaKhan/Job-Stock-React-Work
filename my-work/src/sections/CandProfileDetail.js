                            ...
                            <div className="full-card">
                                <div className="deatil-tab-employ tool-tab">
                                    ...
                                    <ul className="nav simple nav-tabs" id="simple-design-tab">
                                        <li className="active"><Link to="/candidateProfile">About</Link></li>
                                        <li><Link to="/candidateProfile/address">Address</Link></li>
                                        <li><Link to="/candidateProfile/matches-job">Matches Job</Link></li>
                                        <li><Link to="/candidateProfile/friends">Friends</Link></li>
                                        <li><Link to="/candidateProfile/messages">Messages <span className="info-bar">{ClientData[0].messages.length}</span></Link></li>
                                        <li><Link to="/candidateProfile/settings">Settings</Link></li>
                                    </ul>
